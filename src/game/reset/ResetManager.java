...
public class ResetManager {
    ...
    /**
     * Boolean to indicate if the object is able to reset
     */
    private static boolean ableToReset = true;
    ...
    public void run() {
        ...
        for (Resettable resetObj : resettableList) {
            resetObj.resetInstance();
        }
    ...
    /**
     * Method that indicate the game has been reset once and cannot be done again
     */
    public static void hasBeenReset() {
        ableToReset = false;
    }

    /**
     * getter for ableToReset
     *
     * @return boolean value of ableToReset
     */
    public static boolean getAbleToReset() {
        return ableToReset;
    }
}
